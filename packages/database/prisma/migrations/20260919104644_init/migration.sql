...
-- CreateTable
CREATE TABLE "AgendaItemSpeaker" (
    "agendaItemId" TEXT NOT NULL,
    "speakerId" TEXT NOT NULL,
    "role" TEXT DEFAULT 'PANELIST',

    CONSTRAINT "AgendaItemSpeaker_pkey" PRIMARY KEY ("agendaItemId","speakerId")
);
...
CREATE TABLE "ScheduleChange" (
    ...
    "agendaItemId" TEXT,
    "batchId" TEXT,
    "changeType" TEXT NOT NULL DEFAULT 'DELAY',
...
-- AddForeignKey
ALTER TABLE "AgendaItemSpeaker" ADD CONSTRAINT "AgendaItemSpeaker_agendaItemId_fkey" FOREIGN KEY ("agendaItemId") REFERENCES "AgendaItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AgendaItemSpeaker" ADD CONSTRAINT "AgendaItemSpeaker_speakerId_fkey" FOREIGN KEY ("speakerId") REFERENCES "Speaker"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ScheduleChange" ADD CONSTRAINT "ScheduleChange_agendaItemId_fkey" FOREIGN KEY ("agendaItemId") REFERENCES "AgendaItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;
